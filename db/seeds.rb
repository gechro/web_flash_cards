...
pokemon_cards = [{question: 'name the pokemon that looks like an electric mouse', answer: 'pikachu',deck_id: 1}
	,{question: 'name the first pokemon',answer: 'bulbasaur',deck_id: 1}]
